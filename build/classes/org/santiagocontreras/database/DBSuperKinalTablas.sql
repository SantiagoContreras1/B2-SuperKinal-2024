...
create table DetalleCompra(                                               -- UNIDA A COMPRAS
...
VALUES
  ('Distribuidor 1', 'Dirección del Distribuidor 1', '1563325', '47854125'),
  ('Distribuidor 2', 'Dirección del Distribuidor 2', '1256358', '65236523'),
  ('Distribuidor 3', 'Dirección del Distribuidor 3', '154786', '96589658', 'distribuidor3.com');
...
insert into Productos (nombreProducto, descripcionProducto, cantidadStock, precioVentaUnitario, precioVentaMayor, precioCompra, distribuidorId, categoriaProductosId) values
  ('Producto 1', 'Descripción del producto 1', 100, 12.50, 10.00, 8.50, 1, 1),
  ('Producto 2', 'Descripción del producto 2', 75, 15.00, 12.00, 9.50, 2, 2),
  ('Producto 3', 'Descripción del producto 3', 50, 18.00, 15.00, 12.00, 3, 3);
