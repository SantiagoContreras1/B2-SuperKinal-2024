...
public class Promocion {
    ...
    public String toString() {
        return  "ID: " + promocionId + " | " + "Precio Promocion: " + precioPromocion + " | " + "Descripcion: " + descripcionPromocion + " | " + "Fecha de Inicio: " + fechaInicio + " | " + "Fecha de Finalizacion: " + fechaFinalizacion + " | " + "ID Producto: " + productoId + " | ";
    }
