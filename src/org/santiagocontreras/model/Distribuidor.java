...
public class Distribuidor {
    ...
    public String toString() {
        return "ID: " + distribuidorId + " | " + "Nombre Distribuidor: " + nombreDistribuidor + " | " + "Direccion: " + direccionDistribuidor + " | " + "Nit: " + nitDistribuidor + " | " + "Telefono: " + telefonoDistribuidor + " | " + "Web: " + web + " | ";
    }
